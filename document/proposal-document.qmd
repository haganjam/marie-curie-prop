...
**AIRIES** is, at its core an open science project.

1. Sharing of all research materials (i.e. maintaining a publically available repository with all relevant research materials for a project: data, code, documentation etc.)

2. Making research findings available as open-access scientific publications (e.g. via pre-prints or via initiatives such as Peer Community In or Peer Community Journal) and as publically available information that can be used by society.

3. Collaboration with the target end-users which, in this case, are nature management organisations.
