...
To detect our focal IAS, comprising mammals and plants, we will use established primer sets known for their discriminatory power. Mammals will be targeted using the mitochondrial 16S rRNA primers (16Smam1: forward 5′-CGGTTGGGGTGACCTCGGA-3′; 16Smam2: reverse 5′-GCTGTTATCCCTAGGGTAACT-3′), amplifying an approximately 95 bp fragment. Plants will be targeted using nuclear (ITS2) and chloroplast (rbcl) barcode regions. Initially, comprehensive searches for publicly available barcode sequences will be conducted across global genetic repositories including the European Nucleotide Archive (ENA), GenBank, DNA Data Bank of Japan (DDBJ), and Barcode of Life Data Systems (BOLD). Queries will incorporate known synonyms derived from authoritative global taxonomic resources such as the Global Biodiversity Information Facility (GBIF), Integrated Taxonomic Information System (ITIS), and Catalogue of Life.
...
#### WP4: Targeted eDNA sampling of IAS and risk updating
...
Dr. Fabian Roger, is the founder of DNAir, a start-up that focuses on developing airborne eDNA as a large-scale biomonitoring tool. A professional placement is envisaged at DNAir where I will gain experience with what it takes to apply biomonitoring and eDNA techniques in a commercial environment.
